...
const LoginPage = () => {
  ...
  const {
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({queryKey : ["authUser"]}); // it runs the query in the app.js file (queryFn) later it navigates the homepage if user is authenticated from Routes 
    },
  });
